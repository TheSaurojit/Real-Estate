    ...
    <div class="flex items-center justify-between">
        <div>
            <nav class="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-1 flex items-center space-x-2">
                ...
                <span>/</span>
                <span class="text-indigo-600">New Role</span>
            </nav>
            <h1 class="text-2xl font-bold text-slate-800 tracking-tight">Create Custom Operational Role</h1>
            <p class="text-xs text-slate-500 mt-0.5">Define role title, description, and assign modular permissions dynamically.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden" x-data="{
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 text-white flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h3 class="font-bold text-sm">DYNAMIC ROLE CONFIGURATOR</h3>
                    <p class="text-[11px] text-indigo-100">Granular Permission Matrix</p>
                </div>
            </div>
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST" class="p-6 sm:p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-5 rounded-xl border border-slate-200/80">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required
                           ...
                           placeholder="e.g. Senior Sales Manager or Chief Engineer">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="description" name="description" value="{{ old('description') }}"
                           ...
                           placeholder="e.g. Handles flat bookings, job sheets, and sales contracts">
                </div>
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between border-b border-slate-200 pb-2">
                    ...
                    <span class="text-xs text-slate-400">Check permissions to grant access</span>
                </div>
