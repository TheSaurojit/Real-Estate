...
class BookingCancellationRefund extends Model
{
    ...
    protected $casts = [
        ...
        'loan_refund_instruction'    => 'decimal:2',
        'taxable_refund_instruction' => 'decimal:2',
        'cash_refund_instruction'    => 'decimal:2',
        'cancellation_charge_loan'    => 'decimal:2',
        'cancellation_charge_taxable' => 'decimal:2',
        'cancellation_charge_cash'    => 'decimal:2',
